	...
	half3 viewDirectionWS)
{
    ...
    #if defined(GRASS_PBR_INVERTED_LIGHTING)
    ...
    half3 color = GrassDirectBDRF(brdfData, normalWS, specularNormal, lightDirectionWS, viewDirectionWS);
    color *= radiance;
